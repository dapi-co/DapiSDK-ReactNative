...
@property (nonatomic, strong,nullable) UILabel *messageTextLabel;

- (instancetype)initWithError:(NSError *)error delegate:(id<MessageViewControllerDelegate>)delegate;
- (instancetype)initWithErrorMessage:(NSString *) errorMessage  error:(NSError *)error delegate:(id<MessageViewControllerDelegate>)delegate;
