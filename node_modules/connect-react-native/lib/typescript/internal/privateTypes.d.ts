...
export interface DapiConnectNativeModule {
    ...
    createTransfer(userID: string, accountID: string | null, toBeneficiary: IBeneficiary | null, amount: number, remark: string | null): Promise<any>;
    createTransferToExistingBeneficiary(userID: string, accountID: string, toBeneficiaryID: string, amount: number, remark: string | null): Promise<any>;
    ...
    nymcardLoadFunds(userID: string, token: string, accountID: string | null, amount: number): Promise<any>;
}
